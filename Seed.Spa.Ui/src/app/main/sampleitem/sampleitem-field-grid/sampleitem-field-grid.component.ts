...
@Component({
    selector: 'app-sampleitem-field-grid',
    templateUrl: './sampleitem-field-grid.component.html',
    styleUrls: ['./sampleitem-field-grid.component.css']
})
export class SampleItemFieldGridComponent implements OnInit {
