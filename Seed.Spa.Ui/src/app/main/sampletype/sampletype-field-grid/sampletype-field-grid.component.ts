...
@Component({
    selector: 'app-sampletype-field-grid',
    templateUrl: './sampletype-field-grid.component.html',
    styleUrls: ['./sampletype-field-grid.component.css']
})
export class SampleTypeFieldGridComponent implements OnInit {
